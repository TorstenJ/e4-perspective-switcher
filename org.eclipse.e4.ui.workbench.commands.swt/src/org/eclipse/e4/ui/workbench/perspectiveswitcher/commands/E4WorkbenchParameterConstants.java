...
/**
 * Command parameter constant definitions.
 *
 */
public class E4WorkbenchParameterConstants {
  ...
  /**
   * Name for command parameter "Perspective ID" (value is <code>"Perspective ID"</code>).
   */
  public static final String COMMAND_PERSPECTIVE_ID$_NAME = "Perspective ID";

  /**
   * Whether the command parameter "Perspective ID" is optional (value is <code>true</code>).
   */
  public static final boolean COMMAND_PERSPECTIVE_ID$_OPTION = true;

  /**
   * Id for command parameter "Window" (value is <code>"org.eclipse.e4.ui.perspectives.parameters.window"</code>).
   */
  public static final String COMMAND_PERSPECTIVE_WINDOW = "org.eclipse.e4.ui.perspectives.parameters.window"; //$NON-NLS-1$

  /**
   * Name for command parameter "Window" (value is <code>"The Current Window"</code>).
   */
  public static final String COMMAND_PERSPECTIVE_WINDOW$_NAME = "The Current Window";

  /**
   * Whether the command parameter "Window" is optional (value is <code>true</code>).
   */
  public static final boolean COMMAND_PERSPECTIVE_WINDOW$_OPTION = true;

  /**
   * Id for command parameter "New Window" (value is <code>"org.eclipse.e4.ui.perspectives.parameters.newWindow"</code>
   * ).
   */
  public static final String COMMAND_PERSPECTIVE_NEW_WINDOW = "org.eclipse.e4.ui.perspectives.parameters.newWindow"; //$NON-NLS-1$

  /**
   * Name for command parameter "New Window" (value is <code>"Open in New Window"</code>).
   */
  public static final String COMMAND_PERSPECTIVE_NEW_WINDOW$_NAME = "Open in New Window";

  /**
   * Whether the command parameter "New Window" is optional (value is <code>true</code>).
   */
