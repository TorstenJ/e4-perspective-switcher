...
public interface E4WorkbenchCommandConstants {
	...
	/**
	 * Id for category "Perspectives" (value is
	 * <code>"org.eclipse.e4.ui.perspectives"</code>).
	 */
	public static final String CATEGORY_PERSPECTIVES = "org.eclipse.e4.ui.perspectives"; //$NON-NLS-1$

	/**
	 * Name for category "Perspectives" (value is
	 * <code>"Perspectives Category"</code>).
	 */
	public static final String CATEGORY_PERSPECTIVES$_NAME = "Perspectives"; //$NON-NLS-1$

	/**
	 * Description for category "Perspectives" (value is
	 * <code>"Manipulation of workbench perspectives"</code>).
	 */
	...
	/**
	 * Name for command "Show Perspective" in category "Perspectives" (value is
	 * <code>"Show Perspective"</code>).
	 */
	...
	/**
	 * Id for command "Save As" in category "Perspectives" (value is
	 * <code>"org.eclipse.e4.ui.perspectives.saveAs"</code> ).
	 */
	public static final String PERSPECTIVES_SAVE_AS = "org.eclipse.e4.ui.perspectives.saveAs"; //$NON-NLS-1$

	/**
	 * Name for command "Save As" in category "Perspectives" (value is
	 * <code>"Save &As..."</code>).
	 */
	...
	/**
	 * Id for command "Reset" in category "Perspectives" (value is
	 * <code>"org.eclipse.e4.ui.perspectives.reset"</code>).
	 */
	public static final String PERSPECTIVES_RESET = "org.eclipse.e4.ui.perspectives.reset"; //$NON-NLS-1$

	/**
	 * Name for command "Reset" in category "Perspectives" (value is
	 * <code>"&Reset"</code>).
	 */
	...
	/**
	 * Id for command "Close" in category "Perspectives" (value is
	 * <code>"org.eclipse.e4.ui.perspectives.close"</code>).
	 */
	public static final String PERSPECTIVES_CLOSE = "org.eclipse.e4.ui.perspectives.close"; //$NON-NLS-1$

	/**
	 * Name for command "Close" in category "Perspectives" (value is
	 * <code>"&Close"</code>).
	 */
	public static final String PERSPECTIVES_CLOSE$_NAME = "&Close"; //$NON-NLS-1$

	/**
	 * Description for command "Close" in category "Perspectives" (value is
	 * <code>"Closes the perspective"</code>).
	 */
	...
	/**
	 * Name for command "Show Text" in category "Perspectives" (value is
	 * <code>"Show &Text"</code>).
	 */
