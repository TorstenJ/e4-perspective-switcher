...
public class SelectPerspectiveDialog extends Dialog implements ISelectionChangedListener {
  ...
  private void createViewer(Composite parent) {
    ...
    viewer.setLabelProvider(new DelegatingLabelProviderWithTooltip(ContextInjectionFactory.make(
        PerspectiveLabelProvider.class, context), ContextInjectionFactory
        .make(PerspectiveLabelDecorator.class, context)) {
  ...
  protected void okPressed() {
    ...
    ParameterizedCommand command = commandService.createCommand(
        E4WorkbenchCommandConstants.PERSPECTIVES_SHOW_PERSPECTIVE, parameters);
