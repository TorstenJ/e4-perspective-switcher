...
/**
 * All definitions and initialization for the preferences of the perspective switcher.
 *
 */
public class E4PerspectiveSwitcherPreferences {
  ...
  /** preference for showing the "new perspective" button (when <code>true</code>) */
  public static final String SHOW_NEW_BUTTON = "perspective_switcher_show_new_button"; //$NON-NLS-1$

  /** preference for enabling the menus on the perspective buttons (when <code>true</code>) */
